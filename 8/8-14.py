...
accept an arbitrary number of keyword arguments. Call the func- tion with the required 
...
def build_car(model, make, **vars):
    """Function to take attributes of a vehicle and return them"""
